...
function findClick(){
  const firstBoxValue=document.querySelector('.firstBox').value;
  const secondBoxValue=document.querySelector('.secondBox').value;
  const noneTag=document.querySelector('p');
